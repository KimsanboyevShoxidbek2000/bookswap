...
import './MeningElonlarim.css'
import Footer from "../../components/Footer/Footer";
import Button from "../../components/Button/Button";
const MeningElonlarim = () => {
    const [show , setShow] = useState(false)
    const [search , setSearch] = useState(false)
    return (
      <div className={'MeningElonlarim'}>
          ...
          {/*Navbar section end*/}
          <div className={'MElonlar container-fluid'}>
              <div className="row">
                  <div className="col-12 MElonlar-top">
                      <h1>
                          Mening e'lonlarim
                      </h1>
                  </div>
                  ...
                  <div className="col-12 MElonlar-bottom">
                      <Button BtnTitle={'Kitob joylash'} BtnLink={'/kitobJoylash'}/>
                  </div>
              </div>
          </div>
          <Footer/>
...
export default MeningElonlarim;